...
| חיבור | חור | הרכבה |
|---|---|---|
| **USB** | חלון 10 × 4.5 מ"מ + שקע רדוד 12.4 × 7 לראש התקע, 2 חורי M3 במרחק 16.5 | הפלנץ של כבל ה-USB **מבפנים**, 2 ברגי M3 מבחוץ |
...
|---|---|---|
| `PB_MOUNT_DY` | מרחק בין מרכזי שני חורי ההרכבה של הלוח (במרכז הקצוות הקצרים) | 71.5 |
...
את המכסה, ה-hub והקן אפשר להדפיס כבר עכשיו. **את הבסיס — אחרי שמאשרים את 71.5 מ"מ.**
