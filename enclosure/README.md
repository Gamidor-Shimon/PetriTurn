...
3. **לוח:** 2 ברגי M3 בחורי ההרכבה, שורה 1 לכיוון הדופן האחורית, ועמודה J (המהדקים) לכיוון המנוע. מתאם 90° על ה-USB של ה-XIAO, והכבל אליו.
...
9. בדיקה: `petriturn.exe rotate 1 20 cw` — הקן מסתובב חופשי, בלי לשפשף במכסה.
