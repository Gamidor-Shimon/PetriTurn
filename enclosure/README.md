...
| | |
|---|---|
| ![exploded](preview/exploded.png) | ![USB side](preview/usb_side.png) |
...
|---|---|---|
| `stl/base.stl` | גוף הקופסה: דפנות, עמודי ברגים, מעמדים ללוח, חלון USB (בדופן הארוכה), חור לשקע מתח (בדופן הקצרה), חריצי אוורור | כמו שהוא, הפתח למעלה |
...
| לוח הלחמה בסגנון מטריצה 89 × 52, לחתוך ל-32 × 60 | 1 | [perfboard/README.md](../perfboard/README.md) |
...
| `USB_X`, `USB_Z` | מיקום מרכז שקע ה-USB-C **אחרי** הלחמת הלוח (ראו למטה) | מחושב מהלוח, 21.3 |
| `PB_X`, `PB_Y` | רוחב ואורך הלוח **אחרי החיתוך** | 32.0, 60.0 |
...
- לוח הלחמה בסגנון מטריצה, **חתוך ל-32 × 60 מ"מ**, בצד של המנוע, צמוד לפינה של דופן ה-USB.
  4 חורים בפינות, 2.5 מ"מ מהקצוות, לברגי M2.5.
- **ה-XIAO והדרייבר מעל התעלה שבאמצע הלוח**, כמו במטריצה. שקע ה-USB-C פונה **לדופן הארוכה** — לשם החלון.
- צלע הקירור של הדרייבר למעלה, בין חריצי האוורור שבשתי הדפנות הארוכות.
- החיווט — [WIRING.md](../WIRING.md). הסידור המלא על הלוח, עם גשרים וחוטים — [perfboard/README.md](../perfboard/README.md).
...
3. **לוח:** להבריג על 4 המעמדים, שורה 1 (ה-USB) לכיוון הדופן הארוכה. לוודא שה-USB-C מול החלון ושהתקע נכנס עד הסוף.
