...
| **לד STATUS** (בפאנל) | לד 5 מ"מ בבית 8 מ"מ | רגל ארוכה (+) ← `I14`, רגל קצרה (−) ← `J17` | חוטים לפאנל |
...
| 13 | XIAO.D6 | XIAO.D7 |
| 14 | — | R3, **LED+ (לפאנל)** |
| 15 | **פס 3.3V**: W1, W3 | **פס 3.3V**: R2, W1, W2 |
| 16 | TMC.VM, C1 +, **+24V** | TMC.EN, R2, W4 |
| 17 | TMC.GND, C1 −, **0V**, W8, W10 | TMC.MS1, **LED− (לפאנל)**, W8, W9, W11 |
| 18 | TMC.A2, מנוע 1 | TMC.MS2, W9 |
| 19 | TMC.A1, מנוע 2 | TMC.PDN — **לבד** |
| 20 | TMC.B1, מנוע 3 | TMC.USART, W7 |
| 21 | TMC.B2, מנוע 4 | TMC.CLK — **לבד** |
| 22 | TMC.VDD, W3 | TMC.STEP, W5 |
| 23 | TMC.GND, W10 | TMC.DIR, W6 |
| 24–30 | — | — |
...
| W4 | D1 ← EN | `E8` | `H16` | למטה | אפור |
| W5 | D2 ← STEP | `E9` | `F22` | למטה | כחול |
| W6 | D3 ← DIR | `E10` | `I23` | למטה | כחול |
| W7 | D5 ← USART | `E12` | `H20` | למטה | סגול |
...
| W11 | GND של ה-XIAO ← GND | `I8` | `H17` | למטה | שחור |
...
6. חוטים לפאנל (~25 ס"מ): LED+ מ-`I14`, LED− מ-`J17`, RESET מ-`J8`.
...
| `E16` ↔ `F9` | **נתק** | **24V לא מגיע ל-3.3V** |
| `C17` ↔ `F8` | ≈0Ω | GND של הספק = GND של הבקר, הכפתור והלד |
| `C17` ↔ `E23` | ≈0Ω | GND של הלוגיקה בדרייבר |
| `C17` ↔ `G17` | ≈0Ω | MS1 ל-GND |
| `C17` ↔ `F18` | ≈0Ω | MS2 ל-GND |
| `F9` ↔ `E22` | ≈0Ω | 3.3V מגיע ל-VDD |
| `F9` ↔ `F16` | ≈10kΩ | R2: EN ← 3.3V |
| `C8` ↔ `F16` | ≈0Ω | D1 → EN |
| `C9` ↔ `H22` | ≈0Ω | D2 → STEP |
| `C10` ↔ `F23` | ≈0Ω | D3 → DIR |
| `C12` ↔ `F20` | ≈0Ω | D5 → USART |
| `E11` ↔ `F20` | ≈1kΩ | D4 → R1 → USART |
